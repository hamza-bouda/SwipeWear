    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.imageContainer}>
          ...
          <TouchableOpacity style={styles.heartButton} onPress={handleSave} accessibilityRole="button" accessibilityLabel={saved ? 'Retirer du dressing' : 'Sauvegarder la pièce'}>
